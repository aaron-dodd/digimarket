...
## Package Chaincode
./bin/peer lifecycle chaincode package ./src/contract/packages/simple-cn.tar.gz --path ./src/contract/chaincode/simple --label Simple_01
...
./bin/peer lifecycle chaincode install ./src/contract/packages/simple-cn.tar.gz --tls --orderer localhost:7050 --ordererTLSHostnameOverride orderer.digimarket.com --cafile ${PWD}/src/network/organizations/ordererOrganizations/digimarket.com/orderers/orderer.digimarket.com/msp/tlscacerts/tlsca.digimarket.com-cert.pem
